...
It is the 2x standard — 64x96 character cells, 80x96 roll cells, drawn at
half size — the same 96px body height Lia's Blender-rendered atlas is drawn
from (see `art/lia/README.md`), so the heroes match in size and crispness:
