...
Lia's sheet (`dude.png`, generated by `scripts/make-dude-art.py`) is the same
2x standard — 64x96 character cells, 80x96 roll cells, drawn at half size —
so both generated heroes match Anands' crispness instead of the old 1x pixels:

| Sheet | Cells | Content |
|---|---|---|
| `jeffs.png` | 9 x 64x96 | 0-3 walk left, 4 face-on, 5-8 walk right |
| `jeffs-roll.png` | 16 x 80x96 | 0-7 roll right, 8-15 roll left (mirrors) |
